...
2. We allow users to choose from one of the following three assumptions:
    + a. Assume that the variant is rare enough that a single copy has been introduced by one founder, and begin the simulation of the pedigree with this founder.
    ...
    + c. Allow founders to introduce the rare variant with probability proprotional to its allele frequency in the population.  NOTE: Under this assumption: founders may be homozygous for the rare variant, multiple founders may introduce the rare variant, and homozygous offspring may be observed.
...
plot(studyPed2017$kinshipPedigree, cex = 0.9, 
     id = studyPed2017$pedigreeLabels,
...
plot(studyPed2001$kinshipPedigree, cex = 0.9, 
     id = studyPed2001$pedigreeLabels,
     mar = c(1.1, 3.1, 5.1, 2.1))
