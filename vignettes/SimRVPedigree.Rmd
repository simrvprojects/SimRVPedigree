...
11. `RVfounder`: The method by which the rare variant is introduced to the pedigree.  We allow three modes of introduction discussed in [Individual and Pedigree Specific Assumptions](#PedLevel): `'first'`, which corresponds to assumption 2.a.; `'single'`, which corresponds to assumption 2.b.  By default, `RVfounder = 'first'`.
