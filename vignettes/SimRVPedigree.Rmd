...
15. `first_diagnosis`: The first year that reliable diagnoses can be obtained regarding disease-affection status.  Relatives who experience disease-onset prior to `first_diagnosis` do not contribute to the total numer of diesease-affected reletives when ascertaining the pedigree.  By default, `first_diagnosis = NULL` so that all diagnoses are considered reliable.
