...
#' }
#'
#' Users who wish to use \code{trim.ped} for pedigrees not generated by \code{simPed} or \code{simRVped} must use \code{\link{new.ped}} to create an object of class \code{ped}.  The \code{ped} object \emph{must} contain the following variables for each pedigree member:
#' \tabular{lll}{
...
#' @seealso \code{\link{simRVped}}, \code{\link{simPed}}, \code{\link{new.ped}}
#' @export
#'
