...
#'
#' \code{trim_step} chooses a proband from the pedigree and trims relatives based on proband recall probabilities.
#'
#'
...
#' @param recall_probs numeric.  The proband recall probabilities.  See details.
#'
