...
#' }
#'
#' Users who wish to trim pedigrees not been simulated by \code{\link{simRVped}} or \code{\link{simPed}} must ensure that the pedigree, \code{ped_file}, supplied to \code{trim.ped} contains the following variables for each pedigree member:
#'
#' \enumerate{
...
#' }
#'
#' @param ped_file Data.frame. A pedigree generated by \code{simPed}.
