...
#'
#' @param ped_file An object of class \code{ped}. A pedigree generated by \code{simPed} or \code{simRVped}, or an object created by the function \code{new.ped}.  See details.
