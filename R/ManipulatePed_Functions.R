...
#' Obtain information for disease-affected relatives
#'
#' Users who wish to use \code{affInfo.ped} for pedigrees not generated by \code{sim_ped} or \code{sim_RVped} must use \code{\link{new.ped}} to create an object of class \code{ped}.
#'
#' @inheritParams censor.ped
#'
