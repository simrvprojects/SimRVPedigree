...
#'
#' \emph{The \code{reassignGen.ped} function is primarily intended for pedigrees simulated by the \code{simRVPedigree} package.  Results will be inaccurate if inbreeding or loops are present.}
#'
#' The \code{reassignGen.ped} function accepts a pedigree and reassigns generation numbers among disease-affected relatives so that generation 1 represents the generation of the most recent common ancestor of all disease-affected relatives.  We note that the individual in generation 1 could themselves be disease-affected, i.e. an individual can be considered their own ancestor.
#'
...
#'
#' @param ped_file An object of class \code{ped}. A pedigree generated by \code{sim_ped} or \code{simRVped}, or an object created by the function \code{\link{new.ped}}.  See details.
...
#' Obtain information for disease-affected relatives
#'
#' Users who wish to use \code{affInfo.ped} for pedigrees not generated by \code{sim_ped} or \code{simRVped} must use \code{\link{new.ped}} to create an object of class \code{ped}.
#'
#' @inheritParams censor.ped
#'
