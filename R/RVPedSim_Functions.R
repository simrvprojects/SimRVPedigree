...
#' @param random_BR Logical. If \code{TRUE}, reproductive span is restricted to a random interval contained in [18, 45]. By default, \code{random_BR = TRUE}.  See details.
