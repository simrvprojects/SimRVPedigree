...
#' \item{unaffected_death_hazard}{The age-specific hazard rate for death in the UNAFFECTED population}
#' \item{affected_death_hazard}{The age-specific hazard rate for death in the AFFECTED population}
#' }
#'
"ASHR"
