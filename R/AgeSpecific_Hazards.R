...
#'
#' The hazards in this dataset were simulated randomly and do not represent age-specific hazards for a real disease.  These simulated hazards have been included in the `SimRVPedigree` package to simplify examples in object documentation, and serve as the hazards for the rare disease "raramorbo" in the vignette.
#'
#' @docType data
#'
